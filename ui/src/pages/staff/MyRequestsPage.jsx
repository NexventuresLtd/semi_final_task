...
export default function MyRequestsPage() {
  ...
  return (
    <>
      <Helmet><title>{t("requests.myRequestsTitle")} — FERWAFA Approvals</title></Helmet>
      <h1 className="font-display text-2xl font-semibold text-ink dark:text-ink-dark mb-6">{t("requests.myRequestsTitle")}</h1>
