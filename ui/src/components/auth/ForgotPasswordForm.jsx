...
export default function ForgotPasswordForm() {
  ...
  return (
    <>
      ...
      <h1 className="font-display text-2xl text-center font-semibold  mb-1.5">Reset your password</h1>
      <p className="text-sm  muted mb-8 text-center">Enter your email and we'll send you a reset link.</p>
